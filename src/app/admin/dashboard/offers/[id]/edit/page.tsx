        ...
        async function loadOffer() {
            try {
                ...
                if (data.success && data.offer) {
                    ...
                    // Load custom discounts from offer
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <button
                            ...
                            className="w-full bg-gradient-to-r from-ocean to-sky-breeze hover:from-royal hover:to-ocean text-white px-6 py-4 rounded-xl font-bold shadow-lg shadow-ocean/20 transition-all transform hover:scale-105 disabled:opacity-50"
                        >
