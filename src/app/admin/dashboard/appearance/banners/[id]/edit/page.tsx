...
type BannerPosition = 'SINGLE_FULL' | 'DOUBLE';
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto" dir="rtl">
            ...
            <div className="flex items-center gap-4 mb-6">
                ...
                <h1 className="text-2xl font-bold text-gray-800">ویرایش بنر</h1>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-6">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                            عنوان (برای مدیریت) <span className="text-red-500">*</span>
                        </label>
                        <input
                            type="text"
                            value={title}
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                            موقعیت نمایش <span className="text-red-500">*</span>
                        </label>
                        <div className="flex gap-4">
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input
                                    ...
                                    name="position"
                                    value="SINGLE_FULL"
                                    checked={position === 'SINGLE_FULL'}
                                    onChange={() => setPosition('SINGLE_FULL')}
                                    className="w-4 h-4 text-ocean"
                                />
                                <span className="text-sm text-gray-900">تک بنر تمام‌عرض</span>
                            </label>
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input
                                    type="radio"
                                    name="position"
                                    value="DOUBLE"
                                    checked={position === 'DOUBLE'}
                                    onChange={() => setPosition('DOUBLE')}
                                    className="w-4 h-4 text-ocean"
                                />
                                <span className="text-sm text-gray-900">دو بنر کنار هم</span>
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">اندازه پیشنهادی: 768×130 پیکسل</p>
                        <button
                            type="button"
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                ...
                                {mobileImage && (
                                    <div>
                                        ...
                                        <div className="relative w-[180px] h-[30px] bg-gray-100 rounded-lg overflow-hidden mx-auto lg:mx-0">
                                            <img
                                                src={mobileImage}
                                                alt="Mobile Preview"
                                                className="w-full h-full object-cover"
                                                onError={(e) => {
                                                    (e.target as HTMLImageElement).src = 'https://via.placeholder.com/768x130/gray/white?text=Image+Error';
                                                }}
                                            />
                                        </div>
                                    </div>
