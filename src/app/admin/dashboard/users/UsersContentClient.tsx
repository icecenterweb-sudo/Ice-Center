...
export default function UsersContentClient({ initialUsers }: UsersContentClientProps) {
    ...
    // Filter users based on query matching name or phone number
        ...
        <div className="space-y-6 p-6" dir="rtl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="bg-white rounded-xl p-4 border border-gray-200">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <div className="text-2xl font-bold text-gray-800">{initialUsers.length}</div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <div className="text-2xl font-bold text-green-600">
                                {initialUsers.filter(u => u.isVerified).length}
                            </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <div className="text-2xl font-bold text-red-600">
                                {initialUsers.filter(u => u.status === 'BLOCKED').length}
                            </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-4">
                <div className="relative">
                    ...
                    <input
                        type="text"
                        placeholder="جستجوی کاربر با نام یا شماره تلفن..."
                        value={searchQuery}
            ...
            {filteredUsers.length > 0 ? (
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
                    ...
                    <h2 className="text-xl font-bold text-gray-900 mb-2">کاربری یافت نشد</h2>
                    <p className="text-gray-600">هیچ کاربری با عبارت جستجو شده مطابقت ندارد.</p>
                </div>
            )}
        </div>
    );
